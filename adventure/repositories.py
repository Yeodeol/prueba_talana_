...
class JourneyRepository:
    ...
    def end_journey(self,Vehicle: models.Vehicle,Journey:models.Journey) -> bool:
        """"""
        try:
            models.Journey.filter(vehicule = Vehicle,
                        start=Journey.start).update(end = timezone.now().date()).save()
            return True
